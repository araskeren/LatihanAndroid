...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //this.spinner = (Spinner) findViewById(R.id.edKota);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter <String> (this,R.layout.form_main,categories);
        adapter.setDropDownViewResource(R.layout.form_main);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            displayToast(getString(R.string.chose_contact));
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_gallery:
                ...
                //intent.putExtra("data",String.valueOf(this.spinner.getSelectedItem()));
