package com.example.araskeren.appsimplecalc;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Kalkulator mCalculator;
    ...
    public void onAdd(View view) {
        compute(Kalkulator.Operator.ADD);
    }
    ...
    public void onSub(View view) {
        compute(Kalkulator.Operator.SUB);
    }
    ...
    public void onDiv(View view) {
        try {
            compute(Kalkulator.Operator.DIV);
    ...
    public void onMul(View view) {
        compute(Kalkulator.Operator.MUL);
    }

    private void compute(Kalkulator.Operator operator) {
        double operandOne;
        double operandTwo;
        try {
